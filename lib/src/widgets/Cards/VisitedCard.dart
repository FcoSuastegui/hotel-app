...
class VisitedCard extends StatelessWidget {
  final VisitadoModel visited;

  const VisitedCard({Key key, this.visited}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Container(
      child: GestureDetector(
        onTap: () => Routes.inst.getRoute(visited.page),
        child: Container(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: NetworkImage(
                        "${GetStorages.inst.server}/${visited.image}"),
                    fit: BoxFit.cover,
                  ),
